...
const VideoEmbedButton: React.FC<VideoEmbedButtonProps> = ({ onVideoEmbed, disabled = false }) => {
  ...
  const handleEmbed = () => {
    ...
    if (videoUrl.includes('youtube.com') || videoUrl.includes('youtu.be')) {
      ...
      embedHtml = `<video controls autoplay style=\\'width: 100%; height: auto; display: block; border-radius: 8px; background: #000;\\'><source src=\\'${videoUrl}\\' type=\\'video/mp4\\'><source src=\\'${videoUrl}\\' type=\\'video/webm\\'><source src=\\'${videoUrl}\\' type=\\'video/ogg\\'><div style=\\'padding: 2rem; text-align: center; color: white; background: #1f2937;\\'><p>Your browser does not support HTML5 video.</p><a href=\\'${videoUrl}\\' target=\\'_blank\\' style=\\'color: #60a5fa;\\'>Open video in new window</a></div></video>`;
    }
